...
class GaborSession(PylinkEyetrackerSession):
    ...
    def create_trials(self):
        ...
        self.position_x = np.resize(self.settings['Stimulus settings']['Positions'], self.n_trials)
        self.position_y = np.resize(self.settings['Stimulus settings']['Positions'], self.n_trials)
        random.shuffle(self.position_x)
        random.shuffle(self.position_y)
